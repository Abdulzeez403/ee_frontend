      ...
      <div className="container mx-auto p-4">
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="flex overflow-x-auto sm:grid sm:grid-cols-4 gap-2 mb-8 no-scrollbar">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold">
                        Top{" "}
                        {Math.round(
                          (userStats.rank / userStats.totalStudents) * 100
                        )}
                        %
                      </span>
                    </div>
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <div className="text-sm font-medium">
                              {activity.type === "quiz" &&
                                `${activity.subject} Quiz - ${activity.score}%`}
                              {activity.type === "streak" &&
                                `${activity.days} day streak maintained`}
                          ...
                          {achievement.earned ? (
                            ...
                            <div className="mt-2">
                              <div className="text-xs text-gray-500 mb-1">
                                ...
                                {achievement.name === "Study Streak" ? 30 : 10}
                              </div>
                              {/* <Progress
                                value={
                                  (achievement?.progress /
                                    (achievement.name === "Study Streak"
                                      ? 30
                                      : 10)) *
                                  100
                                }
                    ...
                    <CardContent className="p-6">
                      ...
                      <div className="space-y-2">
                        <div className="flex justify-between text-sm text-gray-600">
                          <span>
                            Progress: {subject.completed}/{subject.total}{" "}
                            quizzes
                          </span>
                      ...
                      >
                        ...
                        <div className="flex-1">
                          <div className="font-medium">
                            {activity.type === "quiz" &&
                              `Completed ${activity.subject} Quiz`}
                            {activity.type === "streak" &&
                              `Maintained ${activity.days} day study streak`}
                            {activity.type === "achievement" &&
                              `Unlocked "${activity.name}" achievement`}
                          </div>
                          {activity.score && (
