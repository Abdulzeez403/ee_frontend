...
const exams = [
  {
    ...
    href: "/dashboards/past-questions?exam=waec",
    icon: FileText,
    color: "green",
  ...
  },
  {
    ...
    href: "/dashboards/past-questions?exam=neco",
    icon: FileText,
    color: "blue",
  ...
  },
  {
    ...
    href: "/dashboards/past-questions?exam=jamb",
    icon: GraduationCap,
    color: "purple",
  ...
  },
  {
    ...
    href: "/dashboards/past-questions?exam=post-utme",
    icon: GraduationCap,
    color: "orange",
